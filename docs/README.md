...
- [`auth-and-publishing.md`](auth-and-publishing.md) — GitHub App + Cloudflare Worker setup for
  admin login and report publishing
- [`decisions.md`](decisions.md) — running log of why things are built the way they are, plus
  backlog ideas that came up but were deliberately deferred
